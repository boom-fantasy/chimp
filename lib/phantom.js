var phantomjs = require('phantomjs-bin'), processHelper = require('./process-helper.js'), log = require('./log');
...
Phantom.prototype.start = function(callback) {
    ...
    if (this.options.localstorage) {
        args.push('--local-storage-path=' + this.options.localstorage+this.options.name);
        console.log("localstorage location set to "+this.options.localstorage+this.options.name);
